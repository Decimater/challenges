...
The returned value is less than 10 characters long. Return nil for Ruby, None for Python, null for Java when the hash cannot be cracked with the given characters.
Example:

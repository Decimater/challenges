...
public class Rainfall {
	public static void main(String[] args) {
     ...
     "Lima:Jan 1.2,Feb 0.9,Mar 0.7,Apr 0.4,May 0.6,Jun 1.8,Jul 4.4,Aug 3.1,Sep 3.3,Oct 1.7,Nov 0.5,Dec 0.7";
		...
		System.out.println(mean("London", data));	// ~51.199999999999996
		System.out.println(mean("Beijing", data));	// ~52.416666666666664
		
		System.out.println(variance("London", data));	// ~57.42833333333374
		System.out.println(variance("Beijing", data));	// ~4808.37138888889
	}
